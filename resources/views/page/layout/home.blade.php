...
<section class="hero-slider">
        ...
        <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2698px, 0px, 0px); transition: all 0s ease 0s; width: 9443px;"><div class="owl-item cloned" style="width: 1349px;"><div class="single-slider-item set-bg" data-setbg="img/slider-2.jpg" style="background-image: url(assets/img/slider-2.jpg&quot;);">
        <div class="container">
        <div class="row">
        <div class="col-lg-12">
        <h1>2019</h1>
        ...
        </div></div><div class="owl-item cloned" style="width: 1349px;"><div class="single-slider-item set-bg" data-setbg="img/slider-3.jpg" style="background-image: url(assets/img/slider-3.jpg&quot;);">
        <div class="container">
        <div class="row">
        <div class="col-lg-12">
        <h1>2019</h1>
        ...
        </div></div><div class="owl-item active" style="width: 1349px;"><div class="single-slider-item set-bg" data-setbg="img/slider-1.jpg" style="background-image: url(&quot;img/slider-1.jpg&quot;);">
        <div class="container">
        <div class="row">
        <div class="col-lg-12">
        <h1>2019</h1>
        ...
        </div></div><div class="owl-item" style="width: 1349px;"><div class="single-slider-item set-bg" data-setbg="img/slider-2.jpg" style="background-image: url(&quot;img/slider-2.jpg&quot;);">
        <div class="container">
        <div class="row">
        <div class="col-lg-12">
        <h1>2019</h1>
        ...
        </div></div><div class="owl-item" style="width: 1349px;"><div class="single-slider-item set-bg" data-setbg="img/slider-3.jpg" style="background-image: url(&quot;img/slider-3.jpg&quot;);">
        <div class="container">
        <div class="row">
        <div class="col-lg-12">
        <h1>2019</h1>
        ...
        </div></div><div class="owl-item cloned" style="width: 1349px;"><div class="single-slider-item set-bg" data-setbg="img/slider-1.jpg" style="background-image: url(&quot;img/slider-1.jpg&quot;);">
        <div class="container">
        <div class="row">
        <div class="col-lg-12">
        <h1>2019</h1>
        ...
        </div></div><div class="owl-item cloned" style="width: 1349px;"><div class="single-slider-item set-bg" data-setbg="img/slider-2.jpg" style="background-image: url(&quot;img/slider-2.jpg&quot;);">
        <div class="container">
        <div class="row">
        <div class="col-lg-12">
        <h1>2019</h1>
